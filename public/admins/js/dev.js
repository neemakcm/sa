$(function() {
                ...
                columns: [{
                        ...
                        render: function(data, type, full) {
                            if (full.type == 1)
                                ...
                                return '<video width="60" height="60" controls><source src="' + storage_url + '/' + full.video + '" type="video/mp4"></video>';
                        }
                    },
                    {
                        orderable: false,
    ...
    /*ClassicEditor
        .create( document.querySelector( '.ckeditor' ),{
            ckfinder: {
                uploadUrl: base_url + '/imageUpload'
            },
        } )
        .catch( error => {
            console.error( error );
                ...
                },
                {
                    ...
                    render: function(data, type, full) {
                        if (full.type == 0)
                            ...
                            return '<a href="' + full.video + '" target="_blank"><img class="m-1" src="' + storage_url + '/' + full.thumbnail + '" width="60" height="60"></a>';
                    }
                }
            ],
            "columnDefs": [{
    ...
    if ($('#products_table').length > 0) {
        $('#products_table').DataTable({
            ...
            "columnDefs": [{
                ...
                "render": function(data, type, full) {
                    if (full.type == 1)
                        var td = '<div class="d-flex"><a title="Edit" href="' + base_url + '/admin/products/edit/' + full.id + '"><i class="i-Pen-2 nav-icon"></i></i></a>&nbsp&nbsp&nbsp<a title="Delete" href="' + base_url + '/admin/products/delete/' + full.id + '"><i class="las la-trash" style="font-size:14px"></i></i></a>&nbsp&nbsp&nbsp<a title="Varients" href="' + base_url + '/admin/products/varient/' + full.id + '"><i class="las la-eye" style="font-size:15px"></i></i></a>';
                    else
                        var td = '<div class="d-flex"><a title="Overview" href="' + base_url + '/admin/products/overview/' + full.id + '"><i class="las la-file-alt" style="font-size:15px"></i></i></a>&nbsp&nbsp&nbsp<a title="Edit" href="' + base_url + '/admin/products/edit/' + full.id + '"><i class="i-Pen-2 nav-icon"></i></i></a>&nbsp&nbsp&nbsp<a title="Delete" href="' + base_url + '/admin/products/delete/' + full.id + '"><i class="las la-trash" style="font-size:14px"></i></i></a>&nbsp&nbsp&nbsp<a title="Reviews" href="' + base_url + '/admin/products/reviews/' + full.id + '"><i class="las la-comment" style="font-size:15px"></i></i></a>&nbsp&nbsp&nbsp<a title="Faq" href="' + base_url + '/admin/products/faq/' + full.id + '"><i class="las la-question" style="font-size:15px"></i></i></a>&nbsp&nbsp&nbsp<a target="_blank" title="Front detail page" href="' + base_url + '/products/detail/' + full.slug + '"><i class="las la-play" style="font-size:15px"></i></i></a>&nbsp&nbsp&nbsp<a title="Resize image" href="' + base_url + '/admin/products/resizeImage/' + full.id + '"><i class="las la-recycle" style="font-size:15px"></i></i></a>';
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                $.each(result, function(index, value) {
                    td += '<div class="col-md-6 form-group mb-3 not_configurable"><label>' + value.attribute.name + '*</label><input class="form-control" type="text" placeholder="Enter ' + value.attribute.name + '" name="attribute[' + value.attribute.id + ']" ></div>';
                });
    ...
    if ($('#product_varient_table').length > 0) {
        $('#product_varient_table').DataTable({
            ...
            "columnDefs": [{
                ...
                "visible": true,
                "render": function(data, type, full) {
                    var td = '<div class="d-flex"><a title="Overview" href="' + base_url + '/admin/products/overview/' + full.id + '"><i class="las la-file-alt" style="font-size:15px"></i></i></a>&nbsp&nbsp&nbsp<a title="Edit" href="' + base_url + '/admin/products/varient/edit/' + full.id + '"><i class="i-Pen-2 nav-icon"></i></i></a>&nbsp&nbsp&nbsp<a title="Delete" href="' + base_url + '/admin/products/varient/delete/' + full.id + '"><i class="las la-trash" style="font-size:14px"></i></i></a>&nbsp&nbsp&nbsp<a title="Reviews" href="' + base_url + '/admin/products/reviews/' + full.id + '"><i class="las la-comment" style="font-size:15px"></i></i></a>&nbsp&nbsp&nbsp<a title="Faq" href="' + base_url + '/admin/products/faq/' + full.id + '"><i class="las la-question" style="font-size:15px"></i></i></a>&nbsp&nbsp&nbsp<a target="_blank" title="Front detail page" href="' + base_url + '/products/detail/' + full.slug + '"><i class="las la-play" style="font-size:15px"></i></i></a>&nbsp&nbsp&nbsp<a title="Resize image" href="' + base_url + '/admin/products/resizeImage/' + full.id + '"><i class="las la-recycle" style="font-size:15px"></i></i></a></div>';
    ...
    if ($('#pending_reviews_table').length > 0) {
        $('#pending_reviews_table').DataTable({
            language: { search: '', searchPlaceholder: "Search..." },
            processing: true,
            serverSide: true,
            pageLength: 50,
            ...
            ajax: base_url + '/admin/products/pendingReviewsList',
            columns: [{
                    orderable: false,
                    data: "null",
                    width: '300',
                    autoWidth: false,
                    render: function(data, type, full) {
                        return '<a target="_blank" href="' + base_url + '/admin/products/edit/' + full.product_id + '">' + full.product.name + '</a>';
                    }
                },
                {
                    orderable: false,
            ...
            "columnDefs": [{
                ...
                "visible": true,
                "render": function(data, type, full) {
                    var td = '<div class="d-flex"><a title="Approve" href="' + base_url + '/admin/products/approveReviews/' + full.id + '"><i class="las la-check-circle" style="font-size:20px"></i></i></a>&nbsp;&nbsp;&nbsp<a title="Reject" href="' + base_url + '/admin/products/rejectReviews/' + full.id + '"><i class="las la-times-circle" style="font-size:20px"></i></i></a></div>';
            ...
            createdRow: function(row, data, dataIndex) {
                setTimeout(function() {
                    ...
                    $('#pending_reviews_table tbody').addClass("m-datatable__body");
                    $('#pending_reviews_table tbody tr:odd').addClass("m-datatable__row m-datatable__row--odd");
                    $('#pending_reviews_table tbody tr:even').addClass("m-datatable__row m-datatable__row--even");
                    $('#pending_reviews_table td').addClass("m-datatable__cell");
                    $('#pending_reviews_table_filter input').addClass("form-control m-input");

                    $('#pending_reviews_table tr').css('table-layout', 'fixed');
                });
            }
        });
    }
            ...
            "columnDefs": [{
                ...
                "render": function(data, type, full) {
                    if ($('#type').val() == 1)
                        ...
                        return '<a href="' + base_url + '/admin/homePage/other-product/edit/' + full.id + '" title="Edit"><i class="nav-icon i-Pen-2"></i></i></a>&nbsp;&nbsp;&nbsp<a href="' + base_url + '/admin/homePage/delete/' + full.id + '" title="Delete"><i class="las la-trash" style="font-size:14px"></i></i></a>&nbsp;&nbsp;&nbsp<a title="View" href="' + base_url + '/admin/homePage/view/' + full.id + '"><i class="las la-eye" style="font-size:14px"></i></a>';
                    else if ($('#type').val() == 4 || $('#type').val() == 2 || $('#type').val() == 3)
                        return '<a href="' + base_url + '/admin/homePage/edit/' + full.id + '" title="Edit"><i class="nav-icon i-Pen-2"></i></i></a>&nbsp;&nbsp;&nbsp<a href="' + base_url + '/admin/homePage/delete/' + full.id + '" title="Delete"><i class="las la-trash" style="font-size:14px"></i></i></a>';
                    else
    ...
    $('#mobile_image_upload').change(function(e) {
        var input = this;
        ...
        if (input.files && input.files[0]) {
            ...
            reader.onload = function(e) {
                ...
                $('#mobile_imagePreview').attr('src', e.target.result);
            }
    ...
    $('#tablet_image_upload').change(function(e) {
        var input = this;
        ...
        if (input.files && input.files[0]) {
            ...
            reader.onload = function(e) {
                ...
                $('#tablet_imagePreview').attr('src', e.target.result);
            }
    ...
    $('#description_desktop_image_upload').change(function(e) {
        var input = this;
        ...
        if (input.files && input.files[0]) {
            ...
            reader.onload = function(e) {
                ...
                $('#description_imagePreview').attr('src', e.target.result);
            }
    ...
    $('#description_mobile_image_upload').change(function(e) {
        var input = this;
        ...
        if (input.files && input.files[0]) {
            ...
            reader.onload = function(e) {
                ...
                $('#description_mobile_imagePreview').attr('src', e.target.result);
            }
    ...
    $('#footer_desktop_image_upload').change(function(e) {
        var input = this;
        ...
        if (input.files && input.files[0]) {
            ...
            reader.onload = function(e) {
                ...
                $('#footer_imagePreview').attr('src', e.target.result);
            }

            reader.readAsDataURL(input.files[0]);
        }
    });
    $('#footer_mobile_image_upload').change(function(e) {
        var input = this;
        ...
        if (input.files && input.files[0]) {
            ...
            reader.onload = function(e) {
                ...
                $('#footer_mobile_imagePreview').attr('src', e.target.result);
            }
    ...
    if ($('#pages_table').length > 0) {
        $('#pages_table').DataTable({
            ...
            "columnDefs": [{
                ...
                "visible": true,
                "render": function(data, type, full) {
                    if (full.slug == "service-policy-charges-1") {
                        return '<a href="' + base_url + '/admin/pages/service-policy"><i class="nav-icon i-Pen-2"></i></i></a>';
                    } else if (full.slug == "drop-point") {
                        return '<a href="' + base_url + '/admin/pages/drop-point"><i class="nav-icon i-Pen-2"></i></i></a>';
                    } else {
        ...
        $('#management_table').DataTable({
            ...
            "columnDefs": [{
                ...
                "render": function(data, type, full) {
                    ...
                    return '<div class="d-flex"><a title="Edit" href="' + base_url + '/admin/managements/edit/' + full.id + '"><i class="nav-icon i-Pen-2"></i></i></a></div>';
    ...
    if ($('#media_center_table').length > 0) {
        $('#media_center_table').DataTable({
            language: { search: '', searchPlaceholder: "Search..." },
            processing: true,
            serverSide: true,
            pageLength: 50,
            ...
            ajax: base_url + '/admin/mediaCenter/list',
            columns: [{
                    orderable: false,
                    data: "null",
                    width: '300',
                ...
                },
                {
                    ...
                    autoWidth: false,
                    render: function(data, type, full) {
                        return '<div class="d-flex"><a title="Edit" href="' + base_url + '/admin/mediaCenter/edit/' + full.id + '"><i class="nav-icon i-Pen-2"></i></i></a>&nbsp;&nbsp;&nbsp<a title="Delete" href="' + base_url + '/admin/mediaCenter/delete/' + full.id + '"><i class="las la-trash" style="font-size:14px"></i></i></a></div>';
                    }
                }
            ],
            createdRow: function(row, data, dataIndex) {
                setTimeout(function() {
                    ...
                    $('#media_center_table tbody').addClass("m-datatable__body");
                    $('#media_center_table tbody tr:odd').addClass("m-datatable__row m-datatable__row--odd");
                    $('#media_center_table tbody tr:even').addClass("m-datatable__row m-datatable__row--even");
                    $('#media_center_table td').addClass("m-datatable__cell");
                    $('#media_center_table_filter input').addClass("form-control m-input");

                    $('#media_center_table tr').css('table-layout', 'fixed');
                });
            }
        });
    }
    ...
    if ($('#job_fields_table').length > 0) {
        $('#job_fields_table').DataTable({
            language: { search: '', searchPlaceholder: "Search..." },
            processing: true,
            serverSide: true,
            pageLength: 50,
            ...
            ajax: base_url + '/admin/jobFields/list',
            columns: [{
                    orderable: false,
                    data: "null",
                    width: '300',
                ...
                },
                {
                    ...
                    autoWidth: false,
                    render: function(data, type, full) {
                        var td = '<div class="d-flex"><a title="Edit" href="' + base_url + '/admin/jobFields/edit/' + full.id + '"><i class="nav-icon i-Pen-2"></i></i></a>';

                        if (full.jobs.length == 0)
                            td += '&nbsp;&nbsp;&nbsp<a title="Delete" href="' + base_url + '/admin/jobFields/delete/' + full.id + '"><i class="las la-trash" style="font-size:14px"></i></i></a>';
            ...
            createdRow: function(row, data, dataIndex) {
                setTimeout(function() {
                    ...
                    $('#job_fields_table tbody').addClass("m-datatable__body");
                    $('#job_fields_table tbody tr:odd').addClass("m-datatable__row m-datatable__row--odd");
                    $('#job_fields_table tbody tr:even').addClass("m-datatable__row m-datatable__row--even");
                    $('#job_fields_table td').addClass("m-datatable__cell");
                    $('#job_fields_table_filter input').addClass("form-control m-input");

                    $('#job_fields_table tr').css('table-layout', 'fixed');
                });
            }
        });
    }
        ...
        $('#jobs_table').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    autoWidth: false,
                    render: function(data, type, full) {
                        var td = '<div class="d-flex"><a title="Edit" href="' + base_url + '/admin/jobs/edit/' + full.id + '"><i class="nav-icon i-Pen-2"></i></i></a>&nbsp;&nbsp;&nbsp<a title="Delete" href="' + base_url + '/admin/jobs/delete/' + full.id + '"><i class="las la-trash" style="font-size:14px"></i></i></a>';

                        if (full.job_request.length > 0)
                            td += '&nbsp;&nbsp;&nbsp<a title="Job Requests" href="' + base_url + '/admin/jobs/requests/' + full.id + '"><i class="las la-comment-dots" style="font-size:14px"></i></a>';
            ...
            createdRow: function(row, data, dataIndex) {
                setTimeout(function() {
                    ...
                    $('#jobs_table tbody').addClass("m-datatable__body");
                    $('#jobs_table tbody tr:odd').addClass("m-datatable__row m-datatable__row--odd");
                    $('#jobs_table tbody tr:even').addClass("m-datatable__row m-datatable__row--even");
                    $('#jobs_table td').addClass("m-datatable__cell");
                    $('#jobs_table_filter input').addClass("form-control m-input");

                    $('#jobs_table tr').css('table-layout', 'fixed');
                });
            }
        });
    }
    ...
    if ($('#job_request_table').length > 0) {
        $('#job_request_table').DataTable({
            language: { search: '', searchPlaceholder: "Search..." },
            processing: true,
            serverSide: true,
            pageLength: 50,
            ...
            ajax: base_url + '/admin/jobs/requestList?id=' + $('#id').val(),
            columns: [{
                    orderable: false,
                    data: "null",
                    width: '300',
                ...
                },
                {
                    ...
                    autoWidth: false,
                    render: function(data, type, full) {
                        var td = '<div class="d-flex"><a title="View" href="' + base_url + '/admin/jobs/requests/view/' + full.id + '"><i class="las la-eye" style="font-size:14px"></i></a></div>';
            ...
            createdRow: function(row, data, dataIndex) {
                setTimeout(function() {
                    ...
                    $('#job_request_table tbody').addClass("m-datatable__body");
                    $('#job_request_table tbody tr:odd').addClass("m-datatable__row m-datatable__row--odd");
                    $('#job_request_table tbody tr:even').addClass("m-datatable__row m-datatable__row--even");
                    $('#job_request_table td').addClass("m-datatable__cell");
                    $('#job_request_table_filter input').addClass("form-control m-input");

                    $('#job_request_table tr').css('table-layout', 'fixed');
                });
            }
        });
    }
    ...
    $('#type').change(function() {
        ...
        if ($('#page_type').val() == 'add') {
            if (val == 0) {
                $('.video_holder').removeClass('hide');
                $('.video_input').attr('required', 'required');
                $('.youtube_holder').addClass('hide');
                $('.youtube_input').removeAttr('required');
            } else {
                $('.video_holder').addClass('hide');
                $('.video_input').removeAttr('required');
                $('.youtube_holder').removeClass('hide');
                $('.youtube_input').attr('required', 'required');
            }
        } else {
            if (val == 0) {
                $('.video_holder').removeClass('hide');
                if ($('#video_status').val() == 0 && $('.video_input').val() == '')
                    $('.video_input').attr('required', 'required');
                $('.youtube_holder').addClass('hide');
                $('.youtube_input').removeAttr('required');
            } else {
    ...
    if ($('#footer_settings_table').length > 0) {
        $('#footer_settings_table').DataTable({
            language: { search: '', searchPlaceholder: "Search..." },
            processing: true,
            serverSide: true,
            pageLength: 50,
            ...
            ajax: base_url + '/admin/footerSettings/list',
            columns: [{
                    orderable: false,
                    data: "null",
                    width: '300',
            ...
            "columnDefs": [{
                ...
                "visible": true,
                "render": function(data, type, full) {
                    return '<div class="d-flex"><a title="Edit" href="' + base_url + '/admin/footerSettings/edit/' + full.id + '"><i class="nav-icon i-Pen-2"></i></i></a>&nbsp;&nbsp;&nbsp<a title="Delete" href="' + base_url + '/admin/footerSettings/delete/' + full.id + '"><i class="las la-trash" style="font-size:14px"></i></i></a></div>';
                }
            }],
            createdRow: function(row, data, dataIndex) {
                setTimeout(function() {

                    $('#footer_settings_table tbody').addClass("m-datatable__body");
                    $('#footer_settings_table tbody tr:odd').addClass("m-datatable__row m-datatable__row--odd");
                    $('#footer_settings_table tbody tr:even').addClass("m-datatable__row m-datatable__row--even");
                    $('#footer_settings_table td').addClass("m-datatable__cell");
                    $('#footer_settings_table_filter input').addClass("form-control m-input");

                    $('#footer_settings_table tr').css('table-layout', 'fixed');
                });
            }
        });
    }
    if ($('#footer_category_settings_table').length > 0) {
        $('#footer_category_settings_table').DataTable({
            language: { search: '', searchPlaceholder: "Search..." },
            processing: true,
            serverSide: true,
            pageLength: 50,
            ...
            ajax: base_url + '/admin/footerCategorySettings/list',
            columns: [{
                    orderable: false,
                    data: "null",
                    width: '300',
            ...
            "columnDefs": [{
                ...
                "visible": true,
                "render": function(data, type, full) {
                    return '<div class="d-flex"><a title="Edit" href="' + base_url + '/admin/footerCategorySettings/edit/' + full.id + '"><i class="nav-icon i-Pen-2"></i></i></a>&nbsp;&nbsp;&nbsp<a title="Delete" href="' + base_url + '/admin/footerCategorySettings/delete/' + full.id + '"><i class="las la-trash" style="font-size:14px"></i></i></a></div>';
                }
            }],
            createdRow: function(row, data, dataIndex) {
                setTimeout(function() {

                    $('#footer_category_settings_table tbody').addClass("m-datatable__body");
                    $('#footer_category_settings_table tbody tr:odd').addClass("m-datatable__row m-datatable__row--odd");
                    $('#footer_category_settings_table tbody tr:even').addClass("m-datatable__row m-datatable__row--even");
                    $('#footer_category_settings_table td').addClass("m-datatable__cell");
                    $('#footer_category_settings_table_filter input').addClass("form-control m-input");

                    $('#footer_category_settings_table tr').css('table-layout', 'fixed');
                });
            }
        });
    }
    ...
    $('#banner_type').change(function() {
        ...
        if (type == 1) {
            ...
            if ($('#type').val() == 'add') {
                $('.video_holder input').removeAttr('required');
                $('.image_holder input').attr('required', 'required');
            }
            ...
            if ($('#type').val() == 'add') {
                $('.image_holder input').removeAttr('required');
                $('.video_holder input').attr('required', 'required');
            }
        }
    });


    $('#banner_add_form').submit(function(e) {
        e.preventDefault();

        var form = $('#banner_add_form');
        var formData = new FormData(form[0]);

        $.ajax({
            type: "POST",
            url: base_url + '/admin/banners/store',
            contentType: false,
            processData: false,
            data: formData,
            success: function(result) {

                location.href = base_url + '/admin/banners';
            },
    ...
    $('#banner_edit_form').submit(function(e) {
        e.preventDefault();

        var form = $('#banner_edit_form');
        var formData = new FormData(form[0]);

        $.ajax({
            type: "POST",
            url: base_url + '/admin/banners/update',
            contentType: false,
            processData: false,
            data: formData,
            success: function(result) {
