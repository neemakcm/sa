                ...
                <div class="row mb-4">
                    <div class="col-md-12 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                <form method="POST" action="{{URL('admin/footerCategorySettings/update')}}" enctype='multipart/form-data'>
                                    <input type="hidden" name="id" value="{{$footer->id}}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6 form-group mb-3">
                                            <label >Category</label>
                                            <select class="input-select form-control " name="category_id" id="category_id" required readonly>
                                        ...
                                        <div class="col-md-6 form-group mb-3">
                                            ...
                                            <input class="form-control" type="number" name="position" required value="{{$footer->position}}">
                                        </div>
