                ...
                <div class="row mb-4">
                    <div class="col-md-12 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                <form method="POST" action="{{URL('admin/footerSettings/store')}}" enctype='multipart/form-data'>
                                	@csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group mb-3">
                                            <label >Link*</label>
                                            <input class="form-control" type="url" name="link" required value="{{old('link')}}">
                                        </div>

                                        <div class="col-md-6 form-group mb-3">
                                            <label >Type</label>
                                            <select class="form-control" name="type">
                                                <option value="1" <?php echo old('type') == 1?'selected':''; ?>>Service & Support</option>
                                                <option value="2" <?php echo old('type') == 2?'selected':''; ?>>Quick Links</option>
                                            </select>
                                        </div>
