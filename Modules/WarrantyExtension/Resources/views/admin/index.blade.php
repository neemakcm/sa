                ...
                <div class="row mb-4 role-management">
                    <div class="col-md-12 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                <a href="{{URL('admin/warranty-extension/export')}}" class="btn btn-primary float-right">Export</a>
                                <!-- <a href="{{URL('admin/user-manuals/add')}}" type="button" class="btn btn-primary ripple m-1 addBtn">Add Manual</a> -->
                                <div class="table-responsive">                           
                                    <table class="display table table-striped table-bordered" id="extension_table" style="width: 100%;">
                                        <thead>
                                            <tr role="row">
                                            <th>Sl no</th>
...
@stop
@section('script')
    <script src="{{asset('public/admins/js/warranty-extension.js')}}"></script>
@endsection