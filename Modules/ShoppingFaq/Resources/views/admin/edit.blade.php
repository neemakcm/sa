                ...
                <div class="row mb-4">
                    <div class="col-md-12 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                <form method="POST" action="{{URL('admin/shopping-faq/update')}}"  enctype='multipart/form-data'>
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 d-flex">
                                            ...
                                            <a class="btn btn-light ml-3" href="{{URL('admin/shopping-faq')}}">Back</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
