    ...
    <div class="app-admin-wrap layout-sidebar-large">
        ...
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            ...
            <div class="main-content">
                <h4 class="mr-2 font-weight-bold">Edit Job Category</h4>
                ...
                <div class="row mb-4">
                    <div class="col-md-12 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                <form method="POST" action="{{URL('admin/jobFields/update')}}" enctype='multipart/form-data'>
                                	@csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group mb-3">
                                            <label >Image*</label><small> (540x460 px)</small>
                                        ...
                                        <div class="col-md-12 d-flex">
                                            ...
                                            <a class="btn btn-light ml-3" href="{{URL('admin/jobFields')}}">Back</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
