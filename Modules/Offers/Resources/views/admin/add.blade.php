    ...
    <div class="app-admin-wrap layout-sidebar-large">
        ...
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            ...
            <div class="main-content">
                <h4 class="mr-2 font-weight-bold">Add Offer</h4>
                ...
                <div class="row mb-4">
                    <div class="col-md-12 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                <form method="POST" action="{{URL('admin/offers/store')}}" enctype='multipart/form-data'>
                                	@csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group mb-3">
                                            ...
                                            <select class="form-control" name="type">
                                                <option value="0" <?php echo old('type') == 0?'selected':''; ?>>Without Form</option>
                                                <option value="1" <?php echo old('type') == 1?'selected':''; ?>>With Form</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-6 form-group mb-3">
                                            ...
                                            <input class="form-control"  type="date"
                                                placeholder="Enter date" name="from_date" min="<?php echo date('Y-m-d'); ?>" required value="{{old('from_date')}}" id="from_date">
                                        </div>

                                        <div class="col-md-6 form-group mb-3">
                                            <label >To Date*</label>
                                            <input class="form-control"  type="date"
                                                placeholder="Enter date" name="to_date" min="<?php echo date('Y-m-d'); ?>" required value="{{old('to_date')}}" id="to_date">
                                        </div>
