    ...
    <div class="app-admin-wrap layout-sidebar-large">
        ...
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            ...
            <div class="main-content">
                <h4 class="mr-2 font-weight-bold">Add Store</h4>
                ...
                <div class="row mb-4">
                    <div class="col-md-12 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                <form method="POST" action="{{URL('admin/stores/store')}}"  enctype='multipart/form-data'>
                                	@csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group mb-3">
                                            <label >Mobile</label>
                                            <input class="form-control"  type="text"
                                                placeholder="Enter mobile" name="mobile" id="mobile" onkeypress="return ValidateDrop(event);" required>
                                        </div>
