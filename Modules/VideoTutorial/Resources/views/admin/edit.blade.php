                ...
                <div class="row mb-4">
                    <div class="col-md-12 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                <form id="tutorial_edit_form" name="tutorial_edit_form">
                                	@csrf
                                        ...
                                        <div class="row add-member">
                                            <div class="col-md-6 form-group mb-3">
                                                ...
                                                <select class="form-control" name="product_id" disabled>
                                                    <option disabled selected>{{$video->category->name}}</option>
                                                </select>
                                            </div>
                                            <div class="col-md-6 form-group mb-3">
                                            ...
                                            <div class="col-md-6 form-group mb-3">
                                                ...
                                                <img id="imagePreview" src="{{storage_url()}}/{{$video->thumbnail}}" width="60">
                                        ...
                                        <div class="col-md-12 d-flex">
                                            <button type="submit" class="btn btn-primary" id="edit_event_submit">Submit</button>
